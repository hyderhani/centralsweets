...
$_['text_login']    = 'Kamu harus <a href="%s">login</a> atau <a href="%s">buat sebuah akun</a> untuk menyimpan <a href="%s">%s</a> Daftar Keinginan <a href="%s"> Anda </a>!';
$_['text_success']  = 'Berhasil: Anda telah ditambahkan <a href="%s">%s</a> Daftar Keinginan <a href="%s">Anda</a>!';
